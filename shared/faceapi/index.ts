...
const API_URL = env.app.faceApiUrl;
const API_KEY = env.app.faceApiKey;
...
async function callFaceApi(context, contentType, body) {
  const faceApiUrlWithParams = `${API_URL}/detect?returnFaceId=false&returnFaceLandmarks=false&returnFaceAttributes=emotion`;
